...
<title>지원 중 - WAP(We Are Professional)</title>
			...
			<aside class="aside">
				...
				<div class="sidebar">
					...
					<div class="sidebar-nav">
						<ul>
							<li class="active"><a href="" style="color: #fff;">지원 중</a></li>
							<li class=""><a href="completeApply">지원 종료</a></li>
						</ul>
					</div>
				</div>
			</aside>
				...
				<div class="content-inner">
					<div class="process-guide-box" style="margin-bottom: 25px;">
						...
						<div class="process-guide-up">
							<p style="float: left">
								1. 현재 지원 중인 프로젝트 목록입니다.<br> 2. 클라이언트는 프로젝트의 지원자 모집 마감 이후, <strong>최대
									10일간 지원자 검토 기간</strong>을 가집니다.<br> 3. <strong>프로젝트 지원 결과</strong>는
								클라이언트의 <strong>지원자 검토가 완료되면 안내</strong>해드립니다.<br> 4. 4. 클라이언트가 미팅을 원하는 경우, <strong>위시켓에서 개별적으로 연락</strong>을 드립니다.
							</p>
						</div>
