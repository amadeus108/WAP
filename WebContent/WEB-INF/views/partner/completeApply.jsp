...
<title>지원종료 - WAP(We Are Professional)</title>
			...
			<aside class="aside">
				...
				<div class="sidebar">
					...
					<div class="sidebar-nav">
						<ul>
							<li class=""><a href="applyproject">지원 중</a></li>
							<li class="active"><a href="" style="color: #fff;">지원 종료</a></li>
						</ul>
					</div>
				</div>
			</aside>
				...
				<div class="content-inner">
					<div class="process-guide-box" style="margin-bottom: 25px;">
						...
						<div class="process-guide-up">
							<p style="float: left">프로젝트에 지원하였지만, 클라이언트와의 미팅이 성사되지 않은 프로젝트
								목록입니다.</p>
						</div>
