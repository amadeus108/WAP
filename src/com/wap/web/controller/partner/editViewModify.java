...
@WebServlet("/partner/info/editViewModify")
public class editViewModify extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Partner> partnerInfo;
		try {
			partnerInfo = ps.getPartnerInfo(id);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/partner/info/editViewModify.jsp");
