...
import com.wap.web.service.NoticeService;

@WebServlet("/newscenter/wap")
public class NewscenterWap extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/notice/wap.jsp");
